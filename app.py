...
# -------------------------------------------------
# LOAD DATASET (SAFE FOR YOUR CSV FORMAT)
# -------------------------------------------------
@st.cache_data
def load_data():
    df = pd.read_csv(
...
def login_page():
    st.markdown(
        ...
        <h2 style='text-align:center;color:white'>Customer Analysis Platform</h2>
